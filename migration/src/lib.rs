...
mod m0002020_create_sbom_group;
mod m0002021_create_sbom_group_assignment;
...
impl MigratorExt for Migrator {
    fn build_migrations() -> Migrations {
        Migrations::new()
            ...
            .normal(m0002020_create_sbom_group::Migration)
            .normal(m0002021_create_sbom_group_assignment::Migration)
    }
}
